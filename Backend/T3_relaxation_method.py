def relaxation_method(omega=0.5, tol=1e-6, max_iter=100):
    x, y, z = 0, 0, 0  # Initial guesses that we need to guess
    ...
    for iteration in range(max_iter):
        ...
        x, y, z = x_new, y_new, z_new   # Update the valuues here

    return x, y, z, max_iter            # Return max iterations which is  reached 
